...
<<<<<<< HEAD
		if(preg_match("/^[0-9]{3}-[0-9]{3}-[0-9]{4}$/", $phone)) {
			...
			$msg = "$login, your password must contain at least 6 characters of letters, numbers and at least one special character.";
			echo "<script>alert('$msg');history.back();</script>";
		}
	}
		else{
			$msg = "$login, enter a valid phone number 000-000-0000!";
			echo "<script>alert('$msg');history.back();</script>";
			}
		}
=======
